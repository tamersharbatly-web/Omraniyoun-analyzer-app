export default {
  ...
  notSetCorrectly: 'The search or display field is not set correctly.',
  ...
  addCustomSearchSources: 'Add custom search sources',
  interactWithMapWidget: 'Interact with a Map widget',
  synchronizeSettingsWithMapWidget: 'Synchronize with map sources',
  searchPlaceholder: 'Select a map for further configurations.',
  customizeSearchSources: 'Customize search sources',
  autoCollapseOnSelection: 'Auto collapse on selection'
}
